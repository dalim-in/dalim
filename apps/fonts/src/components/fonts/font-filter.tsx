...
export function AdvancedFilterBar({ onFiltersChange, availableTags, availableTypes, totalResults }: AdvancedFilterBarProps) {
    ...
    const toggleFontType = (type: string) => {
        updateFilters({
            fontTypes: filters.fontTypes.includes(type) ? filters.fontTypes.filter((t) => t !== type) : [...filters.fontTypes, type],
        })
    }
            ...
            <div className="grid md:flex gap-2">
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        className="pl-9"
                    />
                    <div className="text-muted-foreground absolute right-3 top-2 text-sm">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                    ...
                    <Popover
                        ...
                        <PopoverContent
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium">Minimum Downloads: {filters.minDownloads}</Label>
                                    <Slider
                                ...
                                {/* View Count Range */}
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium">Minimum Views: {filters.minViews}</Label>
                                    <Slider
                    ...
                    <Link href={session ? '/upload' : `${DALIM_URL}/login`}>
                        <Button>{session ? 'Submit a font' : 'Submit a font'}</Button>
                    </Link>
                </div>
            </div>
