      ...
      <SidebarHeader>
        ...
        <div className="px-2">
          <div className="relative">
            ...
            <Input type="search" placeholder="Search..." className="bg-muted w-full rounded-2xl py-2 pr-4 pl-9" />
          </div>
        </div>
      </SidebarHeader>
              ...
              {sidebarItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  {item.items ? (
                    ...
                    <SidebarMenuButton asChild isActive={item.isActive} className="rounded-2xl">
