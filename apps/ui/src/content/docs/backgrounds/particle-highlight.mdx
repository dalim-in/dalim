---
title: Particles Highlight
description: Interactive particle background and highlight effects with mouse tracking.
component: true
---
...
<ComponentPreview
  ...
  description="Highlight effect that follows the mouse inside child elements."
  align="start"
/>
...
```bash
npx shadcn@latest add https://ui.dalim.in/r/styles/default/particle-highlight.json
```
