        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {graphic.images.map((image, index) => (
                      <div key={index} className="relative">
                        ...
                        />
                        <Badge className="absolute top-2 left-2 bg-green-500">Current</Badge>
                      </div>
                    ))}
                  </div>
                )}
            ...
            <div className="space-y-2">
              ...
              <Input id="title" name="title" defaultValue={graphic.title} placeholder="Enter graphic title" required />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select name="category" defaultValue={graphic.category} required>
                <SelectTrigger>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action cannot be undone. This will permanently delete your graphic and all associated images.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
