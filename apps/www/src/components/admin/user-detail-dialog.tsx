        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="flex items-center gap-4 col-span-3">
              <Switch id="verified" checked={emailVerified} onCheckedChange={setEmailVerified} />
              {!emailVerified && (
                <Button variant="outline" size="sm" onClick={handleSendVerificationEmail} disabled={loading}>
                  Send Verification
                </Button>
              )}
            </div>
