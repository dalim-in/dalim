...
export default async function Page() {
    ...
    return (
        <div>
            <section className="relative -mx-6 -mt-14 h-screen overflow-hidden bg-[linear-gradient(to_bottom,#bfdbfe_40%,#fff_80%)] dark:bg-[linear-gradient(to_bottom,#1e40af_40%,#000_80%)]">
                <div className="">
                ...
                <div className="relative z-10 flex flex-col divide-indigo-300 pt-[35px] dark:divide-indigo-700">
                    <div className="mx-auto flex h-[288px] max-w-[80vw] shrink-0 flex-col items-center justify-center gap-2 px-2 py-4 sm:px-10 lg:px-24">
                        ...
                        <h2 className="text-md text-text-tertiary dark:text-dark-text-tertiary max-w-2xl text-pretty text-center md:text-lg">Get started now. No credit card required.</h2>
                    </div>
