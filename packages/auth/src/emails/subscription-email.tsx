...
export const SubscriptionEmail = ({ name, type }: SubscriptionEmailProps) => {
  ...
  const content = {
    created: `Thanks for subscribing to Dalim! We're excited to have you on board.`,
    updated: `Your subscription to Dalim has been updated.`,
    cancelled: `We're sorry to see you go. Your subscription to Dalim has been cancelled.`,
  }[type];
