...
const vec3 baseColor1 = vec3(1.0, 0.949, 0.0);   // #FFF200
const vec3 baseColor2 = vec3(1.0, 0.894, 0.0);
const vec3 baseColor3 = vec3(0.8, 0.749, 0.0);
  ...
  `
    ...
    return (
        <div className="relative flex h-full w-full items-center justify-center">
            ...
            <div
                ref={ctnDom}
                className="orb-container absolute inset-0 flex items-center justify-center"
            />
        </div>
    )
}
