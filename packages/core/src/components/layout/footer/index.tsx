        ...
        <div className="text-white dark:text-black">
            <footer className="relative before:absolute before:-inset-x-full before:top-0 before:h-px before:bg-[linear-gradient(to_right,--theme(--color-border/.3),--theme(--color-border)_200px,--theme(--color-border)_calc(100%-200px),--theme(--color-border/.3))]">
                <div className="px-3 pt-10">
                    <div className="grid border -my-7 md:-my-0 rounded-3xl bg-brand p-10 gap-12 md:grid-cols-2 lg:grid-cols-4">
                        <div className="relative">
                            <h2 className="mb-4 text-3xl font-bold tracking-tight">Stay Connected</h2>
                            <p className="text-white/40 dark:text-black/60 mb-6">Join our newsletter for the latest updates and exclusive offers.</p>
                            <form className="relative">
                                ...
                                <Button
                                    type="submit"
                                    size="icon" 
                                    className="bg-white absolute text-black hover:text-white dark:hover:text-black right-0.5 top-0.5 h-8 w-8 rounded-md transition-transform hover:scale-105">
                        ...
                        <div>
                            ...
                            <nav className="space-y-2">
                                <a
                                    href="#"
                                    className="hover:text-white dark:hover:text-black text-white/40 dark:text-black/60 block transition-colors">
                                    Works
                                </a>
                                <a
                                    href="#"
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-6 flex gap-6">
                                <Link
                                    href={'/'}
                                    className="hover:text-white dark:hover:text-black text-white/40 dark:text-black/60">
                                    LinkedIn
                                </Link>
                                <Link
                                    href={'/'}
                    ...
                    <div className="flex flex-col items-center justify-between gap-3 py-4 text-center md:flex-row">
                        ...
                        <nav className="flex gap-4 text-sm">
                            <a
                                href="#"
                                className="hover:text-white dark:hover:text-black text-white/40 dark:text-black/60 transition-colors">
                                Privacy Policy
                            </a>
                            <a
                                href="#"
