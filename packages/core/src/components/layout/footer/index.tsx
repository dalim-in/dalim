                ...
                <div className="pt-10">
                    <div className="bg-brand -my-6 grid gap-12 rounded-3xl border p-10 md:-my-4 md:grid-cols-2 lg:grid-cols-4">
                        <div className="relative">
                            <DalimLogoIcon2 />
                            <h2 className="mb-2 mt-6 text-2xl font-semibold tracking-tight">Stay Connected</h2>
                            <p className="mb-4 text-white/40 dark:text-black/60">Join our newsletter for the latest updates and exclusive offers.</p>
