...
export const NetflixMetadata: LogoMetadata = {
    name: 'Netflix',
    category: 'Design',
...
export const Netflix = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
