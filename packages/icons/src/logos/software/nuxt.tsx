...
export const NuxtMetadata: LogoMetadata = {
    name: 'Nuxt',
    category: 'Software',
...
export const Nuxt = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
