...
export const VisualStudioCodeMetadata: LogoMetadata = {
...
export const VisualStudioCode = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
                    <>
                        ...
                        <g mask="url(#aVisualStudioCode)">
                            ...
                            />
                            <g filter="url(#bVisualStudioCode)">
                                <path
                                    fill="#007ACC"
                            ...
                            <g filter="url(#cVisualStudioCode)">
                                <path
                                    fill="#1F9CF0"
