...
export const GoogleCloudMetadata: LogoMetadata = {
    name: 'GoogleCloud',
    category: 'Software',
...
export const GoogleCloud = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
