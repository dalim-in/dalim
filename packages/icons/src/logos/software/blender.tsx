...
export const BlenderMetadata: LogoMetadata = {
    name: 'Blender',
    category: 'Software',
...
export const Blender = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
