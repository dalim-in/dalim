...
export const XDMetadata: LogoMetadata = {
    name: 'XD',
    category: 'Design',
...
export const XD = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
