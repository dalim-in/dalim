...
export const InDesignMetadata: LogoMetadata = {
    name: 'InDesign',
    category: 'Design',
...
export const InDesign = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
                    <>
                        <g clipPath="url(#indesign__clip0_906_1830)">
                            <path
