...
export const AnimateMetadata: LogoMetadata = {
    name: 'Animate',
    category: 'Design',
...
export const Animate = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
