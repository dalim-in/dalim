...
export const MongoDBMetadata: LogoMetadata = {
    name: 'MongoDB',
    category: 'Database',
    tags: ['technology', 'design'],
    description: 'An icon representing the MongoDB platform logo',
    author: 'Ali Imam',
    created: '2025-06-10',
    variants: ['icon', 'wordmark'],
}

export const MongoDB = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
