...
export const MetaMetadata: LogoMetadata = {
    name: 'Meta',
    category: 'Social',
    tags: ['technology', 'design'],
    description: 'An icon representing the Meta platform logo',
    author: 'Ali Imam',
    created: '2025-06-10',
    variants: ['icon', 'wordmark'],
}

export const Meta = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
