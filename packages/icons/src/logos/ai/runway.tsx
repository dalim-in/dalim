...
export const RunwayMetadata: LogoMetadata = {
    name: 'Runway',
    category: 'AI',
    tags: ['google', 'ai'],
...
export const Runway = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
