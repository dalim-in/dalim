...
export const GrokMetadata: LogoMetadata = {
    name: 'Grok',
    category: 'AI',
    tags: ['google', 'ai'],
...
export const Grok = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
