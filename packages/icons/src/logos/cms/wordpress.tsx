...
export const WordPressMetadata: LogoMetadata = {
    name: 'WordPress',
    category: 'CMS',
    tags: ['technology', 'design'],
    description: 'An icon representing the WordPress platform logo',
    author: 'Ali Imam',
    created: '2025-06-10',
    variants: ['icon', 'wordmark'],
}

export const WordPress = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
