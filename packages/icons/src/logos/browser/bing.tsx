...
export const BingMetadata: LogoMetadata = {
    name: 'Bing',
    category: 'Browser',
...
export const Bing = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
