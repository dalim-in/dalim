...
export const EdgeMetadata: LogoMetadata = {
    name: 'Edge',
    category: 'Browser',
...
export const Edge = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
