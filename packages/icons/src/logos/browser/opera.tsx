...
export const OperaMetadata: LogoMetadata = {
    name: 'Opera',
    category: 'Browser',
...
export const Opera = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
