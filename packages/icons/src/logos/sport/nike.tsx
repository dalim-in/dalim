...
export const NikeMetadata: LogoMetadata = {
  name: 'Nike',
  category: 'Sport',
  tags: ['technology', 'design'],
  description: 'An icon representing the Nike platform logo',
  author: 'Ali Imam',
  created: '2025-06-10',
  variants: ['icon', 'wordmark'],
}

export const Nike = forwardRef<LogosHandle, LogosProps>(
  (
    {
      className,
      size = '24',
