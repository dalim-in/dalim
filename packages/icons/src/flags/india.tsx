...
import { LogosHandle, LogosProps, FlagMetadata } from '../types'

export const IndiaMetadata: FlagMetadata = {
    name: 'India',
    category: 'Flag',
    tags: ['india', 'country'],
...
export const India = forwardRef<LogosHandle, LogosProps>(({ className, size = '24', color = 'currentColor', variant = 'icon', iconStyle = 'default', ...props }, ref) => {
    const renderPaths = () => {
        switch (variant) {
            case 'icon':
                return (
