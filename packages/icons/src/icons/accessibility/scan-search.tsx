...
export const ScanSearchMetadata: IconMetadata = {
    name: 'ScanSearch',
    category: 'Accessibility',
    tags: ['help', 'question', 'support', 'ScanSearch', 'circle', 'faq'],
