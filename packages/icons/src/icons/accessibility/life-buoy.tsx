...
export const LifeBuoyMetadata: IconMetadata = {
    name: 'LifeBuoy',
    category: 'Accessibility',
    tags: ['help', 'question', 'support', 'LifeBuoy', 'circle', 'faq'],
