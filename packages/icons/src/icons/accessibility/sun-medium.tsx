...
export const SunMediumMetadata: IconMetadata = {
    name: 'SunMedium',
    category: 'Accessibility',
    tags: ['help', 'question', 'support', 'SunMedium', 'circle', 'faq'],
