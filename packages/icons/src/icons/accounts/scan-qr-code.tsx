...
export const ScanQrCodeMetadata: IconMetadata = {
    name: 'ScanQrCode',
    category: 'Accounts',
    ...
    const renderPaths = () => {
        switch (variant) {
            case 'stroke':
                return (
                    <>
  <motion.path d="M17 12v4a1 1 0 0 1-1 1h-4" {...motionProps} />
  <motion.path d="M17 3h2a2 2 0 0 1 2 2v2" {...motionProps} />
  <motion.path d="M17 8V7" {...motionProps} />
  <motion.path d="M21 17v2a2 2 0 0 1-2 2h-2" {...motionProps} />
  <motion.path d="M3 7V5a2 2 0 0 1 2-2h2" {...motionProps} />
  <motion.path d="M7 17h.01" {...motionProps} />
  <motion.path d="M7 21H5a2 2 0 0 1-2-2v-2" {...motionProps} />
  <motion.rect x="7" y="7" width="5" height="5" rx="1" {...motionProps} />
</>
