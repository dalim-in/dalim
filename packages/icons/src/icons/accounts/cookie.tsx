...
export const CookieMetadata: IconMetadata = {
    name: 'Cookie',
    category: 'Accounts',
...
export const Cookie = forwardRef<IconsHandle, IconsProps>(({ onMouseEnter, onMouseLeave, className, size = '24', animation = false, color = 'currentColor', variant = 'stroke', loop = false, strokeColor, fillColor, secondaryColor, iconStyle = 'default', strokeWidth = 1, strokeLinecap = 'round', strokeLinejoin = 'round', strokeDasharray = '0 0', outline = false, onClick, outlineColor = '#fff000', ...props }, ref) => {
  ...
  <motion.path
    ...
    {...motionProps}
  />
  <motion.path d="M8.5 8.5v.01" {...motionProps} />
  <motion.path d="M16 15.5v.01" {...motionProps} />
  <motion.path d="M12 12v.01" {...motionProps} />
  <motion.path d="M11 17v.01" {...motionProps} />
  <motion.path d="M7 14v.01" {...motionProps} />
</>
