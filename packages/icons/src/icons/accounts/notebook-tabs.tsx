...
export const NotebookTabsMetadata: IconMetadata = {
    name: 'NotebookTabs',
    category: 'Accounts',
    ...
    const renderPaths = () => {
        switch (variant) {
            case 'stroke':
                return (
                   <>
  <motion.path d="M2 6h4" {...motionProps} />
  <motion.path d="M2 10h4" {...motionProps} />
  <motion.path d="M2 14h4" {...motionProps} />
  <motion.path d="M2 18h4" {...motionProps} />
  <motion.rect width="16" height="20" x="4" y="2" rx="2" {...motionProps} />
  <motion.path d="M15 2v20" {...motionProps} />
  <motion.path d="M15 7h5" {...motionProps} />
  <motion.path d="M15 12h5" {...motionProps} />
  <motion.path d="M15 17h5" {...motionProps} />
</>
