...
export const ContactRoundMetadata: IconMetadata = {
    name: 'ContactRound',
    category: 'Accounts',
    ...
    const renderPaths = () => {
        switch (variant) {
            case 'stroke':
                return (
                    <>
  <motion.path d="M16 2v2" {...motionProps} />
  <motion.path d="M17.915 22a6 6 0 0 0-12 0" {...motionProps} />
  <motion.path d="M8 2v2" {...motionProps} />
  <motion.circle
    cx="12"
    cy="12"
    r="4"
