...
export const IdCardLanyardMetadata: IconMetadata = {
    name: 'IdCardLanyard',
    category: 'Accounts',
            ...
            case 'stroke':
                return (
                    <>
                        ...
                        />
                        <motion.path
                            d="M15 2l-1 2h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h3"
                            {...motionProps}
                        />
                        <motion.path
