...
export const MessageCircleXMetadata: IconMetadata = {
    name: 'MessageCircleX',
    category: 'Accounts',
    ...
    const renderPaths = () => {
        switch (variant) {
            case 'stroke':
                return (
                    <>
  <motion.path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" {...motionProps} />
  <motion.path d="m15 9-6 6" {...motionProps} />
  <motion.path d="m9 9 6 6" {...motionProps} />
</>
