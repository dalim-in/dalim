...
export const RotateCcwKeyMetadata: IconMetadata = {
    name: 'RotateCcwKey',
    category: 'Accounts',
    ...
    const renderPaths = () => {
        switch (variant) {
            case 'stroke':
                return (
                   <>
  <motion.path d="m14.5 9.5 1 1" {...motionProps} />
  <motion.path d="m15.5 8.5-4 4" {...motionProps} />
  <motion.path
    d="M3 12a9 9 0 1 0 9-9 9.74 9.74 0 0 0-6.74 2.74L3 8"
    {...motionProps}
  />
  <motion.path d="M3 3v5h5" {...motionProps} />
  <motion.circle cx="10" cy="14" r="2" {...motionProps} />
</>
